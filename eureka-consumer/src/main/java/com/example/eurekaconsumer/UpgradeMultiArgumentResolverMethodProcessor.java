 ...
 */
@Slf4j
public class UpgradeMultiArgumentResolverMethodProcessor implements HandlerMethodArgumentResolver, ApplicationContextAware,
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        if (CollectionUtils.isEmpty(argumentResolvers)) {
            throw new RuntimeException("项目配置有误， 请检查SpringMVC的参数解析器配置~");
        }
